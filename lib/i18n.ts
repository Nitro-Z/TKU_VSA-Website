...
const vi: T = {
  ...
  about: {
    ...
    values: ['Đoàn Kết', 'Trách Nhiệm', 'Năng Động'],
    community_title: 'Cộng đồng của chúng tôi',
    community_caption: 'Các thành viên TKU VSA tại sự kiện năm học 2026–2027',
    subnav_intro: 'Giới thiệu',
    subnav_team: 'Ban Chấp Hành',
  },
  team: {
    hero_label: 'TKU VSA — Năm học 2026–2027',
...
const en: T = {
  ...
  about: {
    ...
    values: ['Unity', 'Responsibility', 'Dynamism'],
    community_title: 'Our Community',
    community_caption: 'TKU VSA members at the 2026–2027 academic year event',
    subnav_intro: 'About',
    subnav_team: 'Executive Board',
  },
  team: {
    hero_label: 'TKU VSA — Academic Year 2026–2027',
...
const zh: T = {
  ...
  about: {
    ...
    values: ['團結', '責任', '積極'],
    community_title: '我們的社群',
    community_caption: 'TKU VSA 成員於 2026–2027 學年度活動合影',
    subnav_intro: '關於我們',
    subnav_team: '執行委員會',
  },
  team: {
    hero_label: 'TKU VSA — 2026–2027 學年度',
    hero_title: '執行委員會',
